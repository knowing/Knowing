 ...
 * @author  Franz Graf (added method to split strings, changed some Vector to List, added constructors)
...
public class CSVFileReader extends CSVFile {
     ...
     * @throws FileNotFoundException  If the file to be read does not exist
     */
    public CSVFileReader(String inputFileName, char sep) throws
     ...
     * @throws FileNotFoundException  If the file to be read does not exist
     */
    public CSVFileReader(String inputFileName, char sep, char qual) throws
            FileNotFoundException {
        super(sep, qual);
        in = new BufferedReader(new FileReader(inputFileName));
    }
     ...
     * CSVFileReader constructor with a given field separator.
     *
     * @param  inputFile              The CSV file to be opened for reading
     * @param  sep                    The field separator to be used; overwrites the default one
     * @throws FileNotFoundException  If the file to be read does not exist
     */
